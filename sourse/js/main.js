...
// ----------------player--------------------------
  ...
  let PlayerWindow = document.querySelector('.player'),
      VideoWindow = document.querySelector('.video-window'),
      PlayerButtonPlay = document.querySelector('.video-play'),
